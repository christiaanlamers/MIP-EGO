...
def CNN_conf(cfg):
    ...
    #        entry_no -= 1
    with open("Temp_result.txt", "w") as text_file:
    ...
    call(["./MI_test_functions/msphere/msphere","Temp_result.txt","Temp_result_out.txt"])
    lines = [line.rstrip('\n') for line in open("Temp_result_out.txt")]
    print("lines:")
    print(lines)
